...
const gold = "#c9a96e"
const border = "#2a2a2a"
const courseNote = "Course video — appears inside the Training Foundations program for paid members."

type Asset = { assignedTo: string; url?: string | null; isPublished: boolean; title: string }

const GROUPS: { label: string; where: string; keys: string[] }[] = [
  {
    label: "Landing Page — Home (lisafitmethod.com)",
    where: "This video appears on the PUBLIC home page, below the 'What's inside' section — visible to everyone before they buy. Must be uploaded as MP4. MOV files will not play in Chrome or Firefox.",
    keys: ["lp_trailer"],
  },
  {
  ...
  return (
    <div>
      ...
      <p style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: "0.75rem", color: "#888", marginBottom: "2.5rem" }}>
        Upload videos for each slot. Once published, the site shows your video instead of YouTube. Always upload as MP4.
      </p>
