...
function labelForKind(k: Kind): string {
  switch (k) {
    ...
    case "nutrition-message": return "Nutrition Submission"
    ...
    case "cancellation": return "Cancellation Scheduled"
    case "cancellation-reversed": return "Cancellation Reversed"
  }
}
