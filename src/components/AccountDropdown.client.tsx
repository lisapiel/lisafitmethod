  ...
  return (
    <div ref={ref} style={{ position: "relative", flexShrink: 0 }}>
      <style>{`
        ...
        .ad-portal-row:hover { background: rgba(201,169,110,0.07) !important; }
        .ad-locked-row:hover { background: rgba(201,169,110,0.05) !important; }
        .ad-signout:hover { color: #888 !important; }
        .ad-account-link:hover { background: rgba(255,255,255,0.03) !important; }
      `}</style>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 7, minWidth: 0 }}>
                    <svg width="9" height="11" viewBox="0 0 9 11" fill="none" style={{ flexShrink: 0 }}>
                      <rect x="0.5" y="4.5" width="8" height="6" rx="0.5" stroke={gold} strokeWidth="1" opacity="0.6"/>
                      <path d="M2.5 4.5V3A2 2 0 0 1 6.5 3v1.5" stroke={gold} strokeWidth="1" opacity="0.6"/>
                    </svg>
                    <span style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: "0.68rem", color: "rgba(240,230,211,0.5)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {portal.label}
                    </span>
                  </div>
                  <span style={{ fontFamily: "var(--font-montserrat), sans-serif", fontSize: "0.7rem", color: "rgba(201,169,110,0.5)", flexShrink: 0 }}>→</span>
                </Link>
              ))}
            </div>
          )}
